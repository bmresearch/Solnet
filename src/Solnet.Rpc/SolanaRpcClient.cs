...
internal class SolanaRpcClient : JsonRpcClient, IRpcClient
{
    ...
    {
        return new(_idGenerator.GetNextId(), method, parameters);
    }
    ...
    {
        return parameter != defaultValue ? KeyValue.Create("commitment", parameter) : null;
    }
    ...
    {
        return parameter != defaultValue ? KeyValue.Create("transactionDetails", parameter) : null;
    }
    ...
    public RequestResult<ResponseValue<SimulationLogs>> SimulateTransaction(string transaction,
        ...
        IList<string> accountsToReturn = null)
    {
        return SimulateTransactionAsync(transaction, sigVerify, commitment, replaceRecentBlockhash, accountsToReturn)
            .Result;
    }
