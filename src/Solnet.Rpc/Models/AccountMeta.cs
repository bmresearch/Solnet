...
/// <summary>
///     Implements the account meta logic, which defines if an account represented by public key is a signer, a writable
///     account or both.
/// </summary>
...
public class AccountMeta
{
    ...
    public static AccountMeta Writable(PublicKey publicKey, bool isSigner)
    {
        return new(publicKey, true, isSigner);
    }
    ...
    /// <param name="isSigner">Whether the account is a signer.</param>
    /// <returns>The <see cref="AccountMeta" /> instance.</returns>
    public static AccountMeta ReadOnly(PublicKey publicKey, bool isSigner)
    {
        return new(publicKey, false, isSigner);
    }
}