...
public class TransactionContentInfo
{
    ...
    /// <summary>
    ///     List of program instructions that will be executed in sequence and committed in one atomic transaction if all
    ///     succeed.
    /// </summary>
...
public class TransactionMeta
{
    ...
    /// <summary>
    ///     List of token balances from before the transaction was processed or omitted if token balance recording was not yet
    ///     enabled during this transaction.
    /// </summary>
    public TokenBalanceInfo[] PreTokenBalances { get; set; }

    /// <summary>
    ///     List of token balances from after the transaction was processed or omitted if token balance recording was not yet
    ///     enabled during this transaction.
    /// </summary>
...
/// <summary>
///     Represents an inner instruction. Inner instruction are cross-program instructions that are invoked during
