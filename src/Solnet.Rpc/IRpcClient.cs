...
public interface IRpcClient
{
    ...
    RequestResult<ResponseValue<TokenMintInfo>> GetTokenMintInfo(string pubKey,
        Commitment commitment = Commitment.Finalized);
    ...
    /// <param name="commitment">The state commitment to consider when querying the ledger state.</param>
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    RequestResult<ResponseValue<TokenAccountInfo>> GetTokenAccountInfo(string pubKey,
        Commitment commitment = Commitment.Finalized);
    ...
    ///         </para>
    ///         <para>
    ///             The <c>transactionDetails</c> parameter is optional, the default value
    ///             <see cref="TransactionDetailsFilterType.Full" /> is not sent.
    ///         </para>
    ///         <para>
    ...
    ///     <see cref="TransactionDetailsFilterType" />.
    /// </param>
    ...
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    [Obsolete(
        "Please use GetBlockAsync whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    [Obsolete(
        "Please use GetBlock whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    [Obsolete(
        "Please use GetBlocksAsync whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    Task<RequestResult<List<ulong>>> GetConfirmedBlocksAsync(ulong startSlot, ulong endSlot = 0,
        Commitment commitment = Commitment.Finalized);
    ...
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    [Obsolete(
        "Please use GetBlocks whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    RequestResult<List<ulong>> GetConfirmedBlocks(ulong startSlot, ulong endSlot = 0,
        Commitment commitment = Commitment.Finalized);
    ...
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    [Obsolete(
        "Please use GetBlocksWithLimitAsync whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    [Obsolete(
        "Please use GetBlocksWithLimit whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    ///     This method should return the string 'ok' if the node is healthy, or the error code along with any information
    ///     provided otherwise.
    /// </summary>
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    ...
    ///     <remarks>
    ///         Unless <c>searchTransactionHistory</c> is included, this method only searches the recent status cache of
    ///         signatures.
    ///     </remarks>
    /// </summary>
    ...
    /// <param name="commitment">The state commitment to consider when querying the ledger state.</param>
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    Task<RequestResult<List<SignatureStatusInfo>>> GetSignaturesForAddressAsync(string accountPubKey,
        ulong limit = 1000,
    ...
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    [Obsolete(
        "Please use GetSignaturesForAddressAsync whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    Task<RequestResult<List<SignatureStatusInfo>>> GetConfirmedSignaturesForAddress2Async(string accountPubKey,
        ulong limit = 1000,
        string before = null, string until = null, Commitment commitment = Commitment.Finalized);
    ...
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    [Obsolete(
        "Please use GetSignaturesForAddress whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    [Obsolete(
        "Please use GetTransactionAsync whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <returns>Returns an object that wraps the result along with possible errors with the request.</returns>
    [Obsolete(
        "Please use GetTransaction whenever possible instead. This method is expected to be removed in solana-core v1.8.")]
    ...
    /// <param name="commitment">The state commitment to consider when querying the ledger state.</param>
    /// <returns>Returns a task that holds the asynchronous operation result and state.</returns>
    Task<RequestResult<VoteAccounts>> GetVoteAccountsAsync(string votePubKey = null,
        Commitment commitment = Commitment.Finalized);
    ...
    /// <param name="sigVerify">
    ///     If the transaction signatures should be verified
    ///     (default false, conflicts with <c>replaceRecentBlockHash</c>.
    /// </param>
    /// <param name="commitment">The block commitment used to retrieve block hashes and verify success.</param>
    /// <param name="replaceRecentBlockhash">
    ///     If the transaction recent blockhash should be replaced with the most recent blockhash
    ///     (default false, conflicts with <c>sigVerify</c>
    /// </param>
