...
internal static class ConfigObject
{
    ...
    {
        Dictionary<string, object> dict = Create(pair1) ?? new Dictionary<string, object>();
    ...
    {
        Dictionary<string, object> dict = Create(pair1, pair2) ?? new Dictionary<string, object>();
    ...
    {
        Dictionary<string, object> dict = Create(pair1, pair2, pair3) ?? new Dictionary<string, object>();
    ...
    internal static Dictionary<string, object> Create(KeyValue pair1, KeyValue pair2, KeyValue pair3, KeyValue pair4,
        KeyValue pair5)
    {
        Dictionary<string, object> dict = Create(pair1, pair2, pair3, pair4) ?? new Dictionary<string, object>();
...
internal static class Parameters
{
    ...
    {
        List<object> list = Create(val1) ?? new List<object>();
        if (val2 != null)
        {
            list.Add(val2);
        }
    ...
    {
        List<object> list = Create(val1, val2) ?? new List<object>();
        if (val3 != null)
        {
            list.Add(val3);
        }
