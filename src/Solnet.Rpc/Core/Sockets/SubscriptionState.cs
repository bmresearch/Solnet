...
public abstract class SubscriptionState
{
    ...
    protected SubscriptionState(IStreamingRpcClient rpcClient, SubscriptionChannel chan,
        IList<object> additionalParameters = default)
    {
    ...
    {
        _rpcClient.Unsubscribe(this);
    }

    /// <inheritdoc cref="Unsubscribe" />
    public async Task UnsubscribeAsync()
    {
        await _rpcClient.UnsubscribeAsync(this).ConfigureAwait(false);
    }
}
...
internal class SubscriptionState<T> : SubscriptionState
{
    ...
    /// <param name="additionalParameters">Additional parameters for this given subscription.</param>
    internal SubscriptionState(SolanaStreamingRpcClient rpcClient, SubscriptionChannel chan,
        Action<SubscriptionState, T> handler, IList<object> additionalParameters = default)
    ...
    protected internal override void HandleData(object data)
    {
        DataHandler(this, (T)data);
    }
}