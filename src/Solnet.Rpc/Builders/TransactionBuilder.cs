...
public class TransactionBuilder
{
    ...
    public byte[] Serialize()
    {
        ...
        MemoryStream buffer = new(signaturesLength.Length + (_signatures.Count * SignatureLength) +
                                  _serializedMessage.Length);
    ...
    ///     Throws exception when the list of signers is null or empty or when the fee payer hasn't
    ///     been set.
    /// </exception>
    ...
    {
        return AddSignature(Encoders.Base58.EncodeData(signature));
    }
