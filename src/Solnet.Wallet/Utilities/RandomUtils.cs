...
public static class RandomUtils
{
    ...
    /// </summary>
    private static volatile byte[] _additionalEntropy;

    /// <summary>
    ///     The entropy index..
    /// </summary>
    private static volatile int _entropyIndex;
    ...
    public static byte[] GetBytes(int length)
    {
        ...
        if (Random == null)
        {
            throw new InvalidOperationException(
                "You must initialize the random number generator before generating numbers.");
        }
    ...
    private static void PushEntropy(byte[] data)
    {
        ...
        byte[] entropy = _additionalEntropy;
    ...
    public static void AddEntropy(byte[] data)
    {
        ...
        byte[] entropy = Utils.Sha256(data);
