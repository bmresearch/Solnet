    ...
    public class MessageTest
    {
        ...
        public void MessageDeserializeTest()
        {
            ...
            CollectionAssert.AreEqual(
                new byte[]
                {
                    0, 0, 0, 0, 240, 29, 31, 0, 0, 0, 0, 0, 165, 0, 0, 0, 0, 0, 0, 0, 6, 221, 246, 225, 215, 101,
                    161, 147, 217, 203, 225, 70, 206, 235, 121, 172, 28, 180, 133, 237, 95, 91, 55, 145, 58, 140,
        ...
        public void MessageSerializeTest()
        {
            Message msg = new()
            {
                Header =
                    new MessageHeader
                    {
                        RequiredSignatures = 2, ReadOnlySignedAccounts = 0, ReadOnlyUnsignedAccounts = 4
                    },
                ...
                Instructions = new List<CompiledInstruction>
                {
                    new()
                    {
                        ...
                        Data = new byte[]
                        {
                            0, 0, 0, 0, 240, 29, 31, 0, 0, 0, 0, 0, 165, 0, 0, 0, 0, 0, 0, 0, 6, 221,
