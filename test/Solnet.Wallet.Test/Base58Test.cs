...
namespace Solnet.Wallet.Test
{
    ...
    public class Base58Test
    {
        public static IEnumerable<object[]> DataSet =>
            new[]
            {
                new object[] {string.Empty, ""}, new object[] {"61", "2g"}, new object[] {"626262", "a3gV"},
                ...
                new object[] {"516b6fcd0f", "ABnLTmg"}, new object[] {"bf4f89001e670274dd", "3SEo3LWLoPntC"},
                new object[] {"572e4794", "3EFU7m"}, new object[] {"ecac89cad93923c02321", "EJDM8drfXA6uyA"},
                new object[] {"10c8511e", "Rt5zm"}, new object[] {"00000000000000000000", "1111111111"}
            };
        ...
        public void ShouldEncodeProperly()
        {
            foreach (object[] i in DataSet)
            {
                ...
                byte[] testBytes = FromHexString(data);
        ...
        public void ShouldThrowFormatExceptionOnInvalidBase58()
        {
            ...
            byte[] expected2 = FromHexString("971a55");
