...
namespace Solnet.Wallet.Test
{
    ...
    public class AccountTest
    {
        ...
        private const string ExpectedEncodedPrivateKey =
        ...
        {
            138, 180, 156, 252, 109, 252, 108, 26, 186, 0, 196, 69, 57, 102, 15, 151, 149, 242, 119, 181, 171, 113,
        ...
        private static readonly byte[] InvalidPrivateKey =
        {
            227, 215, 255, 79, 160, 83, 24, 167, 124, 73, 168, 45, 235, 105, 253, 165, 194, 54, 12, 95, 5, 47, 21,
            158, 120, 155, 199, 182, 101, 212, 80, 173, 138, 180, 156, 252, 109, 252, 108, 26, 186, 0, 196, 69, 57,
            242, 119, 181, 171, 113, 120, 224, 0, 118, 155, 61, 246, 56, 178, 47
        };

        private static readonly byte[] InvalidPublicKey =
        {
            138, 180, 156, 252, 109, 252, 108, 26, 186, 0, 196, 69, 57, 102, 15, 151, 149, 242, 119, 181, 171, 113,
            120, 224, 0, 118, 155, 61
        };
        ...
        {
            Account account = new Account(PrivateKeyString, PublicKeyString);
